...
export default function Chart() {
    ...
    return <section id="chart">
        ...
        <div className="row">
            <ChartCard heading={localStorage.getItem("authenticated") ? "Infant" : "login"} about="Lorem, ipsum dolor sit amet consectetur adipisicing elit. At voluptas laboriosam dicta expedita quos eum veniam, accusantium repudiandae possimus" />
